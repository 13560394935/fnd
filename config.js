...
module.exports = {
    ...
    ROLE: {
        ...
        '合金战士': {
            buffs: [keyMap.h],
            map2Sk: [keyMap.d, keyMap.a, keyMap.s],
            map2BackupSk: null,
            map3Sk: [keyMap.g],
            map3BackupSk: keyMap.q,
            map4Sk: [keyMap.w],
            map4BackupSk: null,
            map5Sk: [keyMap.y, keyMap.skip,keyMap.f],
            map5BackupSk: null,
            map6Sk: [keyMap.e, keyMap.r, keyMap.skip, keyMap.d],
            map6BackupSk: null,
            map7Sks: [keyMap.t, keyMap.skip, keyMap.skip, keyMap.e, keyMap.d, keyMap.f, keyMap.r, keyMap.w, keyMap.a, keyMap.s],
            runSpeed: 50,
            runFirst: 'right',
        },
    },
